...
@php
    $itens = [
        ...
        ['id' => 'acesso', 'rotulo' => 'Acesso', 'icone' => 'M6.5 3h-3v3M13.5 3h3v3M6.5 17h-3v-3M13.5 17h3v-3M7.5 8v1M12.5 8v1M7.5 12.5s1 1 2.5 1 2.5-1 2.5-1', 'principal' => true, 'url' => route('acesso.painel')],
        ['id' => 'configuracoes', 'rotulo' => 'Configurações', 'icone' => 'M10 12.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Zm7-2.5c0 .5-.05.9-.13 1.35l1.4 1.1-1.5 2.6-1.7-.6a6.6 6.6 0 0 1-2.3 1.35L12.5 18h-3l-.27-1.8a6.6 6.6 0 0 1-2.3-1.35l-1.7.6-1.5-2.6 1.4-1.1a6.7 6.7 0 0 1 0-2.7l-1.4-1.1 1.5-2.6 1.7.6a6.6 6.6 0 0 1 2.3-1.35L9.5 2h3l.27 1.8a6.6 6.6 0 0 1 2.3 1.35l1.7-.6 1.5 2.6-1.4 1.1c.08.45.13.85.13 1.35Z', 'principal' => false, 'url' => route('configuracoes.painel')],
    ];
